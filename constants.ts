...
export const URLS = {
  ...
  USERS: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQBIokGV3Yw_J9VBIw1x8lw-cPXJt-jDRMmMlv4Cp8cvHYDvQz_1DA0TCjsk6YBQzdvFwNmq_FxF4Ti/pub?gid=0&single=true&output=csv',
  DATA: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQBIokGV3Yw_J9VBIw1x8lw-cPXJt-jDRMmMlv4Cp8cvHYDvQz_1DA0TCjsk6YBQzdvFwNmq_FxF4Ti/pub?gid=146745037&single=true&output=csv',
  ...
  APP_SCRIPT: 'https://script.google.com/macros/s/AKfycbxsdqcSS9VsPzPtxp96T1mYzof6sAkJxKqv1s9RL_DPtL3zAVox3CqPhUQdv5570gI/exec',
};

export const DEFAULT_CREDS = {
  username: 'admin',
  password: '02965740155'
};

export const COLORS = {
  late: '#ef4444',     // Red 500
  critical: '#7f1d1d', // Red 900 (Darker)
  priority: '#f97316', // Orange 500
  tomorrow: '#eab308', // Yellow 500
